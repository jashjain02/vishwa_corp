...
export const AboutSection: React.FC = () => {
  return (
    <section aria-labelledby="about-heading" className="w-full bg-white">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-[140px] px-[64px] py-[120px]">

        {/* ── Top row: copy + CTA, photo collage ── */}
        <div className="flex w-full items-start justify-between">
          <div className="flex w-[584px] shrink-0 flex-col items-start gap-6">
            <div className="flex w-full flex-col items-start gap-4">
              ...
              <h2 id="about-heading" className="w-full text-[56px] font-medium leading-[1.1] text-[#050505]">
                Specialty Copper &amp; Copper Alloys, Manufactured with Precision
              </h2>

              <p className="w-full text-[24px] font-medium leading-[1.4] tracking-[-0.96px] text-[#050505]">
                We supply critical sectors including Electrical &amp; Power Distribution,
                Aerospace &amp; Defence, Railways, and Heavy Engineering with copper and
                copper alloys manufactured to ASTM, EN, and JIS material specifications.
              </p>
            </div>
          ...
          {/* Photo collage */}
          <div className="relative h-[613px] w-[640px] shrink-0">
            <div className="absolute left-0 top-[48px] flex w-[307.69px] flex-col gap-2 rounded-[20.5px] border border-black/[0.12] bg-white p-[24.6px]">
              ...
              <p className="text-[18.5px] leading-[24.6px] text-[#4a5565]">
                Specialty copper alloys &amp; grades manufactured in-house
              </p>
            </div>
            ...
            <div className="absolute left-[332.31px] top-0 h-[398.97px] w-[307.69px] overflow-hidden rounded-[16.4px]">
              <Image src={cncMachining} alt="CNC machining of a copper alloy component" fill className="object-cover" />
            </div>
        ...
        <div className="flex w-full items-start gap-[100px] text-[#050505]">
          <p className="flex-1 text-[24px] font-medium leading-[1.4] tracking-[-0.96px]">
            Vishwa Corporation manufactures and supplies electrolytic copper, oxygen-free
            copper, and specialty copper alloys engineered to exacting technical specifications.
          </p>
          <p className="w-[640px] text-[32px] font-bold leading-[1.4] tracking-[-1.28px]">
            Our Mumbai-based facility processes copper rods, bars, sheets, tubes and profiles
            through casting, extrusion, drawing, machining and precision finishing — delivering
            custom copper and copper alloy components per technical drawings.
          </p>
        </div>
      </div>
    </section>
